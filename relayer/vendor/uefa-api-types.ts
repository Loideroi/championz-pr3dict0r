/**
 * VENDORED TYPE DEFINITIONS — uefa-api v1.0.2
 *
 * Source: https://github.com/ErikMichelson/uefa-api (npm `uefa-api`, MIT licence)
 * Vendored: 2026-07-04 from the published v1.0.2 dist (`dist/api.d.ts` +
 * `dist/iso3166-1-a2.d.ts`, concatenated; the relative import between the two
 * files replaced by inlining).
 *
 * WHY VENDORED (PRD §7.1): the upstream package has been dormant since June
 * 2024. We treat it as a reference implementation we own — this copy is the
 * source of truth for the UEFA API shapes. If UEFA drifts the schema, patch
 * THIS file (and `src/schema.ts`) rather than waiting on upstream.
 *
 * The npm dependency was installed once to produce this copy and then removed.
 *
 * Upstream licence: MIT © Erik Michelson — see
 * https://github.com/ErikMichelson/uefa-api/blob/main/LICENSE
 */

/* ------------------------------------------------------------------------ */
/* dist/iso3166-1-a2.d.ts                                                    */
/* ------------------------------------------------------------------------ */
...
// (import of Iso31661A2 inlined above)
