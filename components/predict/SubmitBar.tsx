...
export function SubmitBar({
  ...
  return (
    <div className="sticky bottom-[calc(5.25rem+env(safe-area-inset-bottom))] md:bottom-4 flex flex-col gap-3 rounded-2xl border border-glow/50 bg-night-3/95 p-4 shadow-lg shadow-night/60 backdrop-blur">
